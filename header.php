...
<body>
<div class="header">
	<div class="header-top" style="background-image: url(https://images.rawpixel.com/image_800/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvbHIvdjQwNC1hZXctMTIxLWNvbnRvdXJ0ZXh0dXJlXzIuanBn.jpg)">
		<div class="wrap">
			<div class="h-logo" id="imjl">
			<!-- <a href="index.php"><img src="images/mov.jpg" alt="Logo Image Here" width=60% height=60%/></a> -->
		</div>
			  <div class="nav-wrap">
					<ul class="group" id="example-one" style="color: #07F1FC" >
