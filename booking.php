<style>
.button-62 {
  background: linear-gradient(to bottom right, #4C6EF5, #56D4B6);
  border: 0;
  border-radius: 8px;
  color: #FFFFFF;
  cursor: pointer;
...
.button-62:not([disabled]):focus {
  box-shadow: 0 0 0.25rem rgba(0, 0, 0, 0.5), -0.125rem -0.125rem 1rem rgba(76, 110, 245, 0.5), 0.125rem 0.125rem 1rem rgba(86, 212, 182, 0.5);
}
